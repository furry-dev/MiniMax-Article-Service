...
import styles from "./WeightCalculator.module.sass"
            ...
            <form className={styles.calculator} ref={formRef}>
                <div className={styles.modeSelect}>
                    <button
                        ...
                        style={{backgroundColor: mode === "quantityToWeight" ? "cyan" : undefined}}
                        type={"button"}
                    >
                        QTW(вага)
                    </button>
                    <button
                        ...
                        style={{backgroundColor: mode === "weightToQuantity" ? "cyan" : undefined}}
                        type={"button"}
                    >
                        WTQ(кількість)
                    </button>
                ...
                <div className={styles.quantityButtons}>
                    {QUANTITY_BUTTONS.map(button => (
                        <button
                            ...
                            style={{backgroundColor: quantity === button ? "cyan" : undefined}}
                            type="button"
                        >
                            {button.toString()}
                        </button>
